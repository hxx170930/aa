...
#ifndef __AI_MNIST_H__
#define __AI_MNIST_H__
#pragma once
...
#define AI_MNIST_IN_1_SIZE_BYTES  ((28 * 28 * 1) * 4)
...
#define AI_MNIST_OUT_1_SIZE  (1 * 1 * 10)
#define AI_MNIST_OUT_1_SIZE_BYTES  ((1 * 1 * 10) * 4)
